...
class Interface
  ...
  def admin_menu
    @admin_menu = { m00: "0.やめる", m11: "1.商品補充", m12: "2.商品追加", m13: "3.商品撤去", m14: "4.在庫確認", m15: "5.売上確認", m16: "6.釣り銭確認" }
  end
  ...
  def random_buy
    ...
    return puts "全ての在庫がありません。" if @@vending.random_stock.all? {|stock| stock[2] == 0}
